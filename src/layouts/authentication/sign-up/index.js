    ...
    <>
      ...
      {type === "Bank" && (
        <>
          ...
          >
            <MDTypography variant="h4" fontWeight="medium" color="white" mt={1}>
              Bank/Organisation Registration
            </MDTypography>
            <MDTypography display="block" variant="button" color="white" my={1}>
              Enter bank/organisation registration details
            </MDTypography>
          </MDBox>
          <MDBox pt={4} pb={3} px={3}>
            {/* Input Fields for Bank/Organisation */}
            <MDBox component="form" role="form">
              {/* Add inputs for Bank/Organisation details here */}
            </MDBox>
          </MDBox>
        </>
      )}
